...
export const getCoverPreviewMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type CoverPreviewMutationResult = NonNullable<
  Awaited<ReturnType<typeof coverPreview>>
>;
export type CoverPreviewMutationBody = BodyType<CoverPreviewRequest>;
export type CoverPreviewMutationError = ErrorType<ErrorResponse>;
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getCoverPreviewMutationOptions(options));
};
