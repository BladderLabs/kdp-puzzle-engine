...
- estimatedPrice — realistic KDP price given format (large-print + themed = $9.99-12.99)
- prefilledBrief — 1-2 sentences that will be POSTed as the brief to create-book
- giftSku — true when positioning is gift-focused
- giftRecipient — "Mom", "Dad", "Grandma", "Teacher" etc. when giftSku is true

Return STRICT JSON ONLY (no markdown, no commentary):
{
  "opportunities": [ /* 8 entries */ ],
