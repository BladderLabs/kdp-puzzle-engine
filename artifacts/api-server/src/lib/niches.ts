...
export const NICHES: NicheData[] = [
  ...
  },
  {
    ...
    label: "True Crime",
    puzzleType: "Word Search",
    words: ["DETECTIVE","INVESTIGATION","EVIDENCE","WITNESS","SUSPECT","MOTIVE","ALIBI","CRIME","SCENE","FORENSIC","FINGERPRINT","DNA","AUTOPSY","TESTIMONY","INTERROGATE","SURVEILLANCE","COLD","CASE","HOMICIDE","BURGLARY","ROBBERY","FRAUD","CONSPIRACY","VERDICT","COURTROOM","JURY","PROSECUTOR","DEFENSE","APPEAL","CONVICTION","EXONERATE","PAROLE","EVIDENCE","RECORD","TRANSCRIPT","FILE","ARCHIVE","INFORMANT","UNDERCOVER","STAKEOUT","WARRANT","PURSUIT","CAPTURE","ARREST","CONFESSION","PROFILE","PROFILER","PATTERN","COPYCAT","SERIAL","MYSTERY","UNSOLVED","ARCHIVE","CLUE","TRAIL","JUSTICE"],
    titles: ["True Crime Word Search: 100 Famous Cases","True Crime Word Search Volume {N}","Cold Case Word Search Puzzle Book","The Criminal Investigation Word Search","True Crime Puzzle Book for Adults"],
    keywords: ["true crime word search puzzle book","true crime puzzle book adults","cold case word search","detective puzzle book","true crime activity book","criminal investigation puzzle","true crime gift book","mystery word search adults"],
    backBlurb: "For true crime obsessives who want a focused, satisfying way to wind down. 100 large-print word search puzzles themed around detective work, forensic science, famous cases, and the language of the courtroom. Every puzzle comes with a full answer key at the back. Perfect for fans of true crime podcasts, documentaries, and investigation series.",
    recommendedDifficulty: "Medium",
    recommendedCount: 100,
  },
  {
    key: "grandma",
    label: "For Grandma (Gift)",
    puzzleType: "Word Search",
    words: ["GRANDMA","NANA","NANNY","GRAMMY","GRANNY","MIMI","GRANDCHILD","APRON","COOKIES","BAKING","KNITTING","SEWING","QUILT","GARDEN","ROSES","TEACUP","TEAPOT","KETTLE","SUNDAY","FAMILY","PHOTOS","ALBUM","MEMORIES","STORIES","WISDOM","LOVE","HUGS","KISSES","LAUGHTER","SMILES","WARMTH","COMFORT","COZY","BLANKET","ROCKING","CHAIR","FIRESIDE","PRAYERS","BLESSINGS","RECIPE","CASSEROLE","APPLE","PIE","BREAD","JAM","HONEY","TEA","KNIT","CROCHET","HANDMADE","LEGACY","HEIRLOOM","HERITAGE","TRADITION","HEART","KIND","GENTLE","PATIENT"],
    titles: ["For Grandma Word Search 2026: Large Print","Grandma's Word Search Puzzle Book","A Word Search for Grandma Volume {N}","Large Print Grandma Puzzle Book","Word Search for the Best Grandma Ever"],
    keywords: ["grandma word search large print","gift for grandma puzzle book","large print puzzle book grandma","mothers day grandma word search","grandma gift ideas puzzle","grandchild gift for grandma","word search book for grandma","grandmother puzzle book"],
    backBlurb: "A thoughtful gift for the best Grandma in the world. 100 comforting large-print word search puzzles themed around everything Grandma loves — her garden, her kitchen, her grandchildren, and her home. Designed with extra-large letters for comfortable solving. A gift that says I love you, every afternoon, one puzzle at a time.",
    recommendedDifficulty: "Easy",
    recommendedCount: 100,
  },
  {
    key: "grandpa",
    label: "For Grandpa (Gift)",
    puzzleType: "Crossword",
    words: ["GRANDPA","GRANDPOP","POPPY","PAPA","OPA","PA","GRANDSON","GRANDDAUGHTER","WORKSHOP","TOOLBOX","HAMMER","WRENCH","SAW","WOODWORK","GARDEN","SHED","FISHING","TACKLE","ROD","REEL","LURE","BASS","STREAM","RIVER","HIKING","CAMPING","COFFEE","NEWSPAPER","PIPE","RADIO","CHESS","CHECKERS","ARMCHAIR","PORCH","ROCKING","CHAIR","GOLF","VETERAN","UNIFORM","MEDAL","HONOR","STORIES","HISTORY","MEMOIR","WISDOM","LOYAL","STRONG","STEADY","KIND","CARING","GENEROUS","LEGEND","HERO","MENTOR","TEACHER","GUIDE"],
    titles: ["For Grandpa 2026: Large Print Crossword Book","Grandpa's Crossword Puzzle Book","A Crossword for Grandpa Volume {N}","Large Print Crosswords for the Best Grandpa","Word Puzzles for Grandpa"],
    keywords: ["grandpa crossword large print","gift for grandpa puzzle book","large print crossword grandpa","fathers day grandpa crossword","grandpa gift ideas puzzle","crossword book for grandpa","grandfather puzzle book","retirement crossword grandpa"],
    backBlurb: "A great gift for the grandpa who deserves a quiet afternoon. 100 large-print crossword puzzles across easy to medium difficulty, themed around the things Grandpa loves: fishing, woodwork, family, history, and an honest day's work. Full answer key included at the back. A thoughtful Father's Day, birthday, or just-because gift.",
    recommendedDifficulty: "Medium",
    recommendedCount: 100,
  },
  {
    key: "dementia-prevention",
    label: "Dementia Prevention & Brain Health",
    puzzleType: "Word Search",
    words: ["MEMORY","RECALL","RECOGNITION","FOCUS","ATTENTION","COGNITION","NEURON","BRAIN","THINKING","REASONING","PROBLEM","SOLVING","MENTAL","HEALTH","EXERCISE","CLARITY","ALERTNESS","AWARENESS","LEARNING","KNOWLEDGE","WISDOM","INSIGHT","UNDERSTAND","COMPREHEND","PROCESS","CONNECT","ASSOCIATE","PATTERN","SEQUENCE","VOCABULARY","LANGUAGE","READING","CONVERSATION","ENGAGEMENT","SOCIAL","PURPOSE","ROUTINE","HABIT","DAILY","PRACTICE","CONSISTENT","PERSISTENCE","CHALLENGE","STIMULATE","ACTIVATE","STRENGTHEN","PRESERVE","PROTECT","MAINTAIN","RETAIN","VIVID","SHARP","QUICK","CLEAR","BRIGHT","AGILE","FIT","STRONG"],
    titles: ["Dementia Prevention Puzzle Book: 100 Daily Brain Exercises","Brain Health Word Search for Seniors","Daily Cognitive Workout Puzzle Book","Memory & Focus Puzzles for Adults","Keep Your Mind Sharp: Large Print Word Search"],
    keywords: ["dementia prevention puzzle book","brain health puzzle book seniors","cognitive exercise word search","memory improvement puzzles adults","daily brain workout large print","alzheimer prevention activity book","mental fitness puzzle book","senior brain exercise book"],
    backBlurb: "One puzzle a day — a simple habit for long-term brain health. 100 large-print word search puzzles engineered around memory, focus, vocabulary, and associative thinking. Evidence-informed brain-training themes help keep the mind engaged, alert, and sharp. A meaningful gift for yourself, a parent, or a grandparent. Full answer key included.",
    recommendedDifficulty: "Medium",
    recommendedCount: 100,
  },
  {
    key: "brain-workout-daily",
    label: "10-Minute Daily Brain Workout",
    puzzleType: "Word Search",
    words: ["DAILY","ROUTINE","HABIT","MORNING","CONSISTENCY","DISCIPLINE","PRACTICE","MINUTES","FOCUS","ATTENTION","AWARENESS","MINDFUL","CALM","BREATH","INTENTION","CLARITY","ENERGY","VITALITY","STRENGTH","RESILIENCE","PROGRESS","IMPROVEMENT","GROWTH","LEARNING","INSIGHT","INTELLIGENCE","CREATIVITY","CURIOSITY","WONDER","IDEAS","CONNECTION","SYNTHESIS","PERSPECTIVE","REFLECTION","JOURNAL","STREAK","TRACK","GOAL","ACHIEVEMENT","VICTORY","SATISFACTION","PRIDE","ACCOMPLISH","COMPLETE","CHALLENGE","PUZZLE","SOLVE","DECODE","DISCOVER","REVEAL","THINK","REASON","LOGIC","WISDOM","PEACE","BALANCE","STILL"],
    titles: ["10-Minute Daily Brain Workout 2026: 365 Puzzles for a Sharper Mind","Daily Brain Workout Word Search Volume {N}","One Puzzle a Day: A Year of Brain Training","365 Daily Puzzles: 10 Minutes to a Sharper Mind","Daily Mental Workout Puzzle Book"],
    keywords: ["daily brain workout puzzle book","365 day puzzle book adults","10 minute brain training daily","word search one per day book","year of puzzles brain health","brain exercise routine book","daily mental workout adults","cognitive training daily puzzle"],
    backBlurb: "Ten minutes. One puzzle. A sharper mind by the end of the year. 365 word search puzzles — one for every day — designed to build a consistent brain-training habit without eating into your schedule. Each puzzle takes 8-12 minutes to solve. Track your streak at the front of the book. A realistic daily practice, bound into one satisfying volume.",
    recommendedDifficulty: "Medium",
    recommendedCount: 365,
  },
  {
    key: "foodie",
    label: "Foodie & Recipes",
    puzzleType: "Word Search",
    words: ["RECIPE","KITCHEN","COOKING","BAKING","CHEF","CULINARY","INGREDIENT","SEASONING","HERB","SPICE","GARLIC","ONION","BASIL","THYME","ROSEMARY","OREGANO","CINNAMON","PEPPER","SALT","OLIVE","BUTTER","CREAM","FLOUR","SUGAR","YEAST","DOUGH","KNEAD","WHISK","SAUTE","SIMMER","BRAISE","ROAST","GRILL","BRUNCH","DINNER","FEAST","PASTA","RISOTTO","PAELLA","RAMEN","SUSHI","TACO","BURRITO","CURRY","KEBAB","DUMPLING","CROISSANT","BAGUETTE","SOURDOUGH","ESPRESSO","MACARON","TIRAMISU","CROSTATA","GNOCCHI","PROSCIUTTO","CHEESE","WINE","PAIRING","FARMER","MARKET","ORGANIC","FRESH","SEASONAL","TASTE","FLAVOR","SAVORY","UMAMI"],
    titles: ["Foodie Word Search: 100 Recipes to Find","Foodie Word Search Volume {N}","The Home Cook's Word Search Puzzle Book","Kitchen Word Search for Food Lovers","Culinary Word Search Puzzle Book"],
    keywords: ["foodie word search puzzle book","cooking word search adults","recipe word search book","kitchen word search large print","food lover puzzle book","chef gift puzzle book","culinary word search","home cook activity book"],
    backBlurb: "A word search book for the home cook and the curious eater. 100 puzzles themed around recipes, kitchen techniques, world cuisines, herbs, spices, and the vocabulary of the food world. Perfect for quiet evenings, coffee breaks, or as a gift for the food-loving person in your life. Large print for comfortable solving. Answer key included.",
    recommendedDifficulty: "Medium",
    recommendedCount: 100,
  },
];
