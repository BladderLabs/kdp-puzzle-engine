...
// Curated database of 30+ KDP puzzle book niches
// ============================================================
...
export const NICHES: NicheData[] = [
  {
    ...
    words: ["GARDEN","FAMILY","COOKING","TRAVEL","READING","MEMORY","FRIEND","WISDOM","HEALTH","COFFEE","SUNSET","NATURE","PUZZLE","RELAX","PEACE","BRIDGE","CHESS","KNIT","BINGO","WALK","SMILE","GRACE","LAUGH","DANCE","MUSIC","BOOK","LIGHT","HEART","LOVE","CRAFT","SLEEP","REST","CALM","QUIET","JOY","HOPE","FAITH","CARE","KIND","WARM","GENTLE","TENDER","NOBLE","PROUD","BRAVE"],
  ...
  },
  {
    ...
    puzzleType: "Word Search",
    words: ["ANIMAL","SCHOOL","FRIEND","GAME","SPORT","COLOR","MUSIC","DANCE","PIZZA","CAKE","PUPPY","KITTEN","BUNNY","STAR","MOON","SUN","RAINBOW","MAGIC","HAPPY","FUNNY","SILLY","JUMP","RUN","PLAY","LEARN","READ","DRAW","SING","BUILD","LAUGH","CANDY","BALLOON","CASTLE","DRAGON","UNICORN","ROBOT","SUPERHERO","ADVENTURE","TREASURE","JUNGLE"],
  ...
  },
  {
    ...
    label: "Christmas",
    puzzleType: "Word Search",
    words: ["CHRISTMAS","SANTA","REINDEER","RUDOLPH","SLEIGH","GIFT","PRESENT","STOCKING","CHIMNEY","FIREPLACE","MISTLETOE","HOLLY","WREATH","TINSEL","ORNAMENT","ANGEL","STAR","SNOWFLAKE","SNOWMAN","CAROL","BELLS","CELEBRATE","FAMILY","FEAST","TURKEY","CANDLE","RIBBON","MERRY","JOLLY","ELVES","WORKSHOP","NORTH","POLE","WISH","MAGIC","WONDER","WINTER","COZY","WARM","LOVE"],
  ...
  },
  {
    ...
    puzzleType: "Word Search",
    words: ["NURSE","HOSPITAL","DOCTOR","PATIENT","MEDICINE","STETHOSCOPE","SCRUBS","SHIFT","CARE","HEAL","VITAL","PULSE","CHART","SURGERY","NEEDLE","BANDAGE","HEARTBEAT","OXYGEN","MONITOR","DIAGNOSIS","SYMPTOM","TREATMENT","CLINIC","WARD","EMERGENCY","TRIAGE","COMPASSION","DEDICATE","STRENGTH","TEAMWORK","PROCEDURE","PHARMACY","ANESTHESIA","RECOVERY","WELLNESS","HEALTH","PEDIATRIC","ONCOLOGY","TRAUMA","CARDIAC"],
  ...
  },
  {
    ...
    label: "Teachers",
    puzzleType: "Word Search",
    words: ["TEACHER","CLASSROOM","STUDENT","LESSON","HOMEWORK","GRADE","PENCIL","CHALKBOARD","INSPIRE","EDUCATE","CURRICULUM","TEXTBOOK","LIBRARY","SCIENCE","HISTORY","ENGLISH","MATH","ART","MUSIC","RECESS","DIPLOMA","GRADUATION","KNOWLEDGE","WISDOM","PATIENCE","DEDICATION","LEARN","DISCOVER","SUPPORT","MENTOR","ACHIEVEMENT","PROGRESS","SUCCESS","CREATIVE","CURIOUS","BRIGHT","FUTURE","GROW","QUESTION","ANSWER"],
  ...
  },
  {
    ...
    label: "Dog Lovers",
    puzzleType: "Word Search",
    words: ["PUPPY","FETCH","PAWS","WOOF","LEASH","TREAT","COLLAR","RESCUE","ADOPT","LOYAL","PLAYFUL","LABRADOR","POODLE","BULLDOG","BEAGLE","GOLDEN","HUSKY","DALMATIAN","POMERANIAN","CHIHUAHUA","SHEPHERD","TERRIER","SPANIEL","DACHSHUND","KENNEL","GROOMING","TRAINING","OBEDIENCE","AGILITY","SHOW","BREED","BARK","TAIL","SNIFF","DIG","CUDDLE","LOVE","BOND","TRUST","FRIEND"],
    titles: ["Dog Lover Word Search Puzzle Book", "Paw-some Word Search for Dog Lovers Volume {N}", "The Dog Lover's Puzzle Book", "Woof Word Search for Dog People", "Dogs & Puppies Word Search"],
  ...
  },
  {
    ...
    label: "Cat Lovers",
    puzzleType: "Word Search",
    words: ["KITTEN","PURR","MEOW","WHISKER","CLAW","POUNCE","TABBY","SIAMESE","PERSIAN","MAINE","BENGAL","RAGDOLL","SPHYNX","ABYSSINIAN","BIRMAN","BURMESE","NAPPING","GROOMING","PLAYFUL","CURIOUS","INDEPENDENT","ALOOF","GRACEFUL","ELEGANT","HUNTER","NOCTURNAL","SCRATCH","KNEAD","STRETCH","YAWN","CATNIP","LITTER","BOWL","COLLAR","WINDOW","SUNBEAM","PERCH","ROAM","STALK","LEAP"],
    titles: ["Cat Lover Word Search Puzzle Book", "Purr-fect Word Search for Cat Lovers Volume {N}", "The Cat Lover's Puzzle Book", "Meow Word Search for Cat People", "Cats & Kittens Word Search"],
  ...
  },
  {
    ...
    label: "Halloween",
    puzzleType: "Word Search",
    words: ["HALLOWEEN","PUMPKIN","GHOST","WITCH","VAMPIRE","ZOMBIE","MONSTER","SKELETON","SPIDER","COBWEB","HAUNTED","TRICK","TREAT","COSTUME","MASK","CANDY","CAULDRON","BROOMSTICK","BLACK","CAT","BAT","GRAVEYARD","CEMETERY","MOONLIGHT","SCREECH","HOWL","SCARE","FRIGHT","CREEP","EERIE","SINISTER","DARK","CACKLE","BREW","POTION","CURSE","SPELL","HEX","JACK","LANTERN"],
  ...
  },
  {
    ...
    label: "Mother's Day",
    puzzleType: "Word Search",
    words: ["MOTHER","MOM","MOMMY","MAMA","LOVE","HUG","KISS","TENDER","CARE","NURTURE","FAMILY","HOME","HEART","FLOWER","ROSE","GARDEN","BREAKFAST","BRUNCH","CHOCOLATE","CAKE","COFFEE","RELAX","PEACE","STRENGTH","PATIENT","WISDOM","GUIDE","TEACH","PROTECT","CHERISH","BOND","PRECIOUS","BLESSING","GRACE","BEAUTY","WARMTH","COMFORT","SUPPORT","INSPIRE","CELEBRATE"],
  ...
  },
  {
    ...
    label: "Truckers",
    puzzleType: "Word Search",
    words: ["TRUCKER","HIGHWAY","HAUL","FREIGHT","DIESEL","EIGHTEEN","WHEELER","LOAD","CARGO","DISPATCH","ROUTE","MILE","REST","STOP","WEIGH","STATION","LOGBOOK","BRAKE","CLUTCH","GEAR","ENGINE","EXHAUST","HONK","CONVOY","PASS","INTERSTATE","FREEWAY","BRIDGE","TUNNEL","MOUNTAIN","PLAINS","DESERT","DELIVERY","SCHEDULE","DEADLINE","SAFETY","LICENSE","PERMIT","FLATBED","TANKER"],
  ...
  },
  {
    ...
    label: "Gardening",
    puzzleType: "Word Search",
    words: ["GARDEN","PLANT","FLOWER","SEED","SOIL","COMPOST","MULCH","WATER","SUNLIGHT","PRUNE","WEED","HARVEST","GROW","BLOOM","PETAL","STEM","ROOT","LEAF","BRANCH","TREE","SHRUB","HERB","VEGETABLE","TOMATO","ROSE","TULIP","DAISY","LAVENDER","SUNFLOWER","DAHLIA","LILY","IRIS","ORCHID","FERN","MOSS","CACTUS","SUCCULENT","FERTILIZE","POLLINATE","BLOSSOM"],
  ...
  },
  {
    ...
    label: "Cooking & Food",
    puzzleType: "Word Search",
    words: ["RECIPE","INGREDIENT","COOK","BAKE","SIMMER","SAUTE","ROAST","GRILL","FRY","BOIL","WHISK","KNEAD","CHOP","SLICE","DICE","MARINADE","SEASONING","HERB","SPICE","GARLIC","ONION","TOMATO","BUTTER","FLOUR","SUGAR","OLIVE","OIL","PASTA","RISOTTO","SOUFFLE","BRAISE","CASSEROLE","APPETIZER","ENTREE","DESSERT","CHOCOLATE","VANILLA","CINNAMON","BASIL","THYME"],
  ...
  },
  {
    ...
    words: [],
    titles: ["Number Search Puzzle Book Adults", "Find the Numbers Volume {N}", "Number Search Activity Book", "Math Word Search Puzzle Collection", "Number Brain Games Activity Book"],
  ...
  },
  {
    ...
    label: "Father's Day",
    puzzleType: "Word Search",
    words: ["FATHER","DAD","DADDY","PAPA","HERO","STRONG","WISE","GUIDE","PROTECT","PROVIDE","TEACH","COACH","MENTOR","SUPPORT","CHEER","LAUGH","FISH","GOLF","BBQ","GRILL","SPORTS","FOOTBALL","BASEBALL","BASKETBALL","CRICKET","WORKSHOP","BUILD","FIX","DRIVE","GARAGE","TOOLS","WRENCH","HAMMER","POWER","FAMILY","LOVE","BOND","TRUST","PROUD","BRAVE"],
  ...
  },
  {
    ...
    label: "Graduation",
    puzzleType: "Word Search",
    words: ["GRADUATE","DIPLOMA","DEGREE","ACHIEVEMENT","SUCCESS","FUTURE","CAREER","CELEBRATION","CEREMONY","TASSEL","GOWN","CAP","STAGE","APPLAUSE","SPEECH","HONOR","PRIDE","MILESTONE","JOURNEY","DEDICATION","PERSEVERE","KNOWLEDGE","WISDOM","OPPORTUNITY","AMBITION","DREAM","GOAL","PASSION","FOCUS","DISCIPLINE","MENTOR","UNIVERSITY","COLLEGE","SCHOOL","CAMPUS","CLASS","STUDY","EXAM","RESULT","REWARD"],
  ...
  },
  {
    ...
    puzzleType: "Word Search",
    words: ["LOVE","HEART","ROMANCE","PASSION","DESIRE","ADORE","CHERISH","DEVOTION","AFFECTION","TENDER","SWEET","DARLING","BELOVED","KISS","HUG","FLOWER","ROSE","CHOCOLATE","CANDY","LETTER","POEM","DATE","DINNER","CANDLE","MUSIC","DANCE","PROMISE","FOREVER","TOGETHER","SOULMATE","DESTINY","BLISS","JOY","WARMTH","CARE","DREAM","WISH","TREASURE","PRECIOUS","ETERNAL"],
  ...
  },
  {
    ...
    puzzleType: "Word Search",
    words: ["PLANET","STAR","GALAXY","COMET","ASTEROID","METEOR","MOON","SUN","ORBIT","GRAVITY","TELESCOPE","ASTRONAUT","MISSION","LAUNCH","ROCKET","SATELLITE","STATION","MILKY","WAY","UNIVERSE","COSMOS","NEBULA","SUPERNOVA","BLACK","HOLE","QUASAR","PULSAR","ECLIPSE","SOLSTICE","EQUINOX","JUPITER","SATURN","MARS","VENUS","MERCURY","NEPTUNE","URANUS","PLUTO","EUROPA","TITAN"],
  ...
  },
  {
    ...
    label: "Retirement",
    puzzleType: "Word Search",
    words: ["RETIRE","FREEDOM","RELAX","TRAVEL","GARDEN","GOLF","FISH","HOBBY","ENJOY","CELEBRATE","MILESTONE","CHAPTER","NEXT","JOURNEY","LEISURE","PEACEFUL","DESERVE","REST","SLEEP","MORNING","COFFEE","READ","PUZZLE","CRAFT","VOLUNTEER","GRANDCHILD","FAMILY","FRIEND","SOCIAL","ACTIVE","HEALTHY","HAPPY","BLESSED","GRATEFUL","ACHIEVE","SUCCESS","CAREER","LEGACY","HONOR","PROUD"],
  ...
  },
  {
    ...
    puzzleType: "Word Search",
    words: ["MINECRAFT","CREEPER","ZOMBIE","SKELETON","ENDERMAN","DIAMOND","REDSTONE","CRAFTING","SURVIVAL","CREATIVE","BIOME","VILLAGE","CASTLE","DUNGEON","SPAWN","RESPAWN","PORTAL","NETHER","ENDWORLD","DRAGON","PICKAXE","SWORD","SHIELD","ARMOR","ENCHANT","POTION","FARM","BUILD","EXPLORE","MINE","CRAFT","SMELT","FORGE","QUEST","ADVENTURE","PIXEL","BLOCK","CHUNK","RENDER","SERVER"],
  ...
  },
  {
    ...
    label: "Birthday",
    puzzleType: "Word Search",
    words: ["BIRTHDAY","CELEBRATE","PARTY","CAKE","CANDLE","BALLOON","GIFT","PRESENT","FRIEND","FAMILY","LAUGH","DANCE","MUSIC","SURPRISE","CONFETTI","BANNER","WISH","DREAM","JOY","HAPPY","CHEER","TOAST","DRINK","SING","GATHER","MILESTONE","MEMORY","MOMENT","SPECIAL","WONDERFUL","AMAZING","FANTASTIC","INCREDIBLE","TREASURE","CHERISH","LOVE","GROW","SHINE","GLITTER","SPARKLE"],
  ...
  },
  {
    ...
    puzzleType: "Word Search",
    words: ["MINDFUL","BREATHE","CALM","PEACE","RELAX","PRESENT","MOMENT","STILLNESS","SILENCE","MEDITATE","AWARENESS","BALANCE","HARMONY","GENTLE","SLOW","PAUSE","RELEASE","ACCEPT","GROUND","CENTER","FOCUS","CLEAR","SERENE","TRANQUIL","PATIENCE","TRUST","FLOW","OPEN","SOFT","LIGHT","GRATEFUL","THANKFUL","NOTICE","OBSERVE","ALLOW","RETURN","SIMPLE","REST","RESTORE","RENEW"],
